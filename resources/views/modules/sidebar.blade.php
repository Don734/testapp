<aside class="sidebar" id="sidebar">
    <ul class="sidebar-menu">
        ...
        <li class="sidebar-item"><a class="sidebar-link" id="dropdown-toggle" href="{{ url('tables') }}"><span class="icon material-icons">table_chart</span><span class="text">Таблицы</span></a></li>
